from retriving_sap_data import get_mkpf_and_mseg_data
...
mkpf_df, mseg_df = get_mkpf_and_mseg_data(date1, date2, "K11", stor_loc_filter, materials, movement_type_filter, 2000, 4000, 5)
...
final_df.to_excel(output_folder + "/mseg_mkpf_df.xlsx", index=False)
